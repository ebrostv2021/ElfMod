...
public class ElfEntity extends ElfgirlModElements.ModElement {
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, ElfEntity.CustomEntity.class, false, false));
			this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Blocks.POPPY, (int) (1)).getItem()), false));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Elf Girl");
					}
