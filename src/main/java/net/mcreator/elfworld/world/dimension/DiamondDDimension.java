...
import net.mcreator.elfworld.item.DiamondDItem;
...
public class DiamondDDimension extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:diamond_d_portal")
	public static final CustomPortalBlock portal = null;
	public DiamondDDimension(ElfworldModElements instance) {
		super(instance, 102);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("elfworld:diamond_d"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("diamond_d_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("diamond_d_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("diamond_d_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new DiamondDItem().setRegistryName("diamond_d"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("elfworld:diamond_d"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("elfworld:diamond_d")));
				} else {
					entity.func_242279_ag();
