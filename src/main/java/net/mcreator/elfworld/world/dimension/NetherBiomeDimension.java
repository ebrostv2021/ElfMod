...
import net.mcreator.elfworld.item.NetherBiomeItem;
...
public class NetherBiomeDimension extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:nether_biome_portal")
	public static final CustomPortalBlock portal = null;
	public NetherBiomeDimension(ElfworldModElements instance) {
		super(instance, 104);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("elfworld:nether_biome"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("nether_biome_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("nether_biome_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0,
					1).setRegistryName("nether_biome_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new NetherBiomeItem().setRegistryName("nether_biome"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("nether_biome_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("elfworld:nether_biome"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("elfworld:nether_biome")));
				} else {
					entity.func_242279_ag();
