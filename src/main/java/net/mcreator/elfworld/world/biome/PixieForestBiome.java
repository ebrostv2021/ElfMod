...
public class PixieForestBiome extends ElfworldModElements.ModElement {
	public static Biome biome;
	public PixieForestBiome(ElfworldModElements instance) {
		super(instance, 101);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6684673).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-6684673).withFoliageColor(-13369600).withGrassColor(9470285).build();
				...
				event.getRegistry().register(biome.setRegistryName("elfworld:pixie_forest"));
			}
		}
	}
	@Override
