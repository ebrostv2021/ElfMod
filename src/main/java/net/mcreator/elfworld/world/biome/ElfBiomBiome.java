...
import net.mcreator.elfworld.block.ElfLogBlock;
...
public class ElfBiomBiome extends ElfworldModElements.ModElement {
	public static Biome biome;
	public ElfBiomBiome(ElfworldModElements instance) {
		super(instance, 4);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("elfworld:elf_biom"));
			}
		}
	}
	@Override
