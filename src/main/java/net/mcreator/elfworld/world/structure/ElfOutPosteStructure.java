...
package net.mcreator.elfworld.world.structure;
...
public class ElfOutPosteStructure extends ElfworldModElements.ModElement {
	...
	public ElfOutPosteStructure(ElfworldModElements instance) {
		super(instance, 64);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("elf_out_poste"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("elfworld:elf_out_poste"), configuredFeature);
		}
	}
	@SubscribeEvent
