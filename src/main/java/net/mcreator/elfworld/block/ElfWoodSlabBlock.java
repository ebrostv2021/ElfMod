...
public class ElfWoodSlabBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_slab")
	public static final Block block = null;
	public ElfWoodSlabBlock(ElfworldModElements instance) {
		super(instance, 41);
	}
