...
public class ElfWoodLogBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_log")
	public static final Block block = null;
	public ElfWoodLogBlock(ElfworldModElements instance) {
		super(instance, 37);
	}
