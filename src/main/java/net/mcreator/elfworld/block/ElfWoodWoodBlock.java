...
public class ElfWoodWoodBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_wood")
	public static final Block block = null;
	public ElfWoodWoodBlock(ElfworldModElements instance) {
		super(instance, 36);
	}
