...
public class ElfWoodStairsBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_stairs")
	public static final Block block = null;
	public ElfWoodStairsBlock(ElfworldModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("elf_wood_stairs");
		}
