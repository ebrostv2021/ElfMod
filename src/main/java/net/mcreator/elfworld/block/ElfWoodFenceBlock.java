...
public class ElfWoodFenceBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_fence")
	public static final Block block = null;
	public ElfWoodFenceBlock(ElfworldModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("elf_wood_fence");
		}
