...
import net.mcreator.elfworld.item.ElfRawGoldItem;
...
public class ElfOreBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_ore")
	public static final Block block = null;
	public ElfOreBlock(ElfworldModElements instance) {
		super(instance, 21);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ElfRawGoldItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("elfworld:elf_ore_match"), () -> CustomRuleTest.codec);
