...
public class ElfWoodPlanksBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_planks")
	public static final Block block = null;
	public ElfWoodPlanksBlock(ElfworldModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("elf_wood_planks");
		}
