...
public class ElfWoodFenceGateBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_fence_gate")
	public static final Block block = null;
	public ElfWoodFenceGateBlock(ElfworldModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("elf_wood_fence_gate");
		}
