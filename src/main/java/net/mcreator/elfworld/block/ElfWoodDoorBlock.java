...
public class ElfWoodDoorBlock extends ElfworldModElements.ModElement {
	@ObjectHolder("elfworld:elf_wood_door")
	public static final Block block = null;
	public ElfWoodDoorBlock(ElfworldModElements instance) {
		super(instance, 52);
	}
